...
<Note> You can also use the Mercoa admin dashboard to add a bank account, or your customer can add a bank account directly using the iFrame.</Note>
...
<Note> You can also use the Mercoa admin dashboard or iFrame to initiate and verify micro deposits.</Note>

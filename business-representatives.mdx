...
description: Learn what information we require for business representatives. 
---
...
<Note> This only applies to entities set up as businesses. Entities that are set up as individuals will not have a business representative. </Note>
...
company, you can indicate that by making sure `isOwner` = `false`ç and leaving the ownership percentage field blank.

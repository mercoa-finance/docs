...
If you haven't already, [create an `Entity`](/entities) for each of your users. If you are only using Mercoa for email inboxes, entities do not need to be verified.

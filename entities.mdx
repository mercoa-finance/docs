---
title: Entities
description: Create and verify your customers
---
## [API Reference](/api-reference/entity/create)

#

Before your customers can start using Mercoa, they need to be added as an `Entity`. Entities are the individuals and businesses that use Mercoa to pay and get paid. 
...
You can create an entity on the Mercoa [Admin UI](https://mercoa.com/dashboard/entities) or via [API](/api-reference/entity/create).
...
Separate from KYC, Mercoa business entities must verify business representatives before a business account can be verified. [Learn more here](/business-representatives)